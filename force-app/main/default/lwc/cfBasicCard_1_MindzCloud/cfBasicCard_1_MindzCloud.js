import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBasicCard_1_MindzCloud extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`ntfparent`,this._allMergeFields,this._regexPattern,"noparse");
